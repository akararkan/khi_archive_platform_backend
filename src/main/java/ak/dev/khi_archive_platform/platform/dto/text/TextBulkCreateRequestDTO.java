...
/**
 * Bulk-create payload for Text. Same fields as the single-create DTO but
 * accepts the {@code textFileUrl} directly instead of a multipart file part.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class TextBulkCreateRequestDTO extends TextBaseRequestDTO {
    ...
    /** Pre-uploaded text URL (S3 or external). May be null/blank for fixtures. */
