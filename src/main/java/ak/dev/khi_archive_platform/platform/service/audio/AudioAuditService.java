...
import ak.dev.khi_archive_platform.platform.repo.audio.AudioAuditLogRepository;
...
public class AudioAuditService {
    ...
    private final AudioAuditLogRepository auditLogRepository;
    private final SessionRepository sessionRepository;
    private final JwtCookieService jwtCookieService;
    private final JwtTokenProvider jwtTokenProvider;

    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public AudioAuditLog record(Audio audio,
                                AudioAuditAction action,
