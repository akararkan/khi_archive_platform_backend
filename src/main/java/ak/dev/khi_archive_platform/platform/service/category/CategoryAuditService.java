...
import ak.dev.khi_archive_platform.platform.repo.category.CategoryAuditLogRepository;
...
public class CategoryAuditService {
    ...
    public CategoryAuditLog record(Category category,
        ...
        CategoryAuditLog log = CategoryAuditLog.builder()
